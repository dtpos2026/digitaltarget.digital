...
export const themes: ThemeConfig[] = [
  ...
  },
  {
    ...
    description: 'Signature brand purple (#3C096C / #5A189A / #E0AAFF)',
    emoji: '🟣',
    variables: {
      '--background': '270 14% 97%',
      '--foreground': '274 56% 9%',
      '--card': '0 0% 100%',
      '--card-foreground': '274 56% 9%',
      '--primary': '273 89% 23%',
      '--primary-foreground': '0 0% 100%',
      '--secondary': '272 50% 95%',
      '--secondary-foreground': '273 89% 23%',
      '--muted': '270 20% 95%',
      '--muted-foreground': '274 15% 36%',
      '--accent': '276 100% 84%',
      '--accent-foreground': '273 89% 23%',
      '--border': '274 24% 90%',
      '--input': '274 24% 90%',
      '--ring': '273 89% 35%',
      '--gold': '276 100% 84%',
      '--gold-foreground': '273 89% 23%',
      '--pos-sidebar': '273 89% 23%',
      '--pos-sidebar-foreground': '0 0% 100%',
      '--pos-cart': '0 0% 100%',
      '--pos-grid-bg': '270 14% 97%',
      '--sidebar-background': '273 89% 23%',
      '--sidebar-foreground': '0 0% 100%',
      '--sidebar-primary': '276 100% 84%',
      '--sidebar-primary-foreground': '273 89% 23%',
      '--sidebar-accent': '272 73% 32%',
      '--sidebar-accent-foreground': '0 0% 100%',
      '--sidebar-border': '272 50% 40%',
      '--sidebar-ring': '276 100% 84%',
    },
  },
  {
    id: 'emerald-prestige',
...
export function getActiveTheme(): ThemeId {
  // One-time migration: adopt the official DT POS brand purple theme
  try {
    if (!localStorage.getItem('dt-theme-migrated-brand')) {
      localStorage.setItem('desi-pos-theme', 'dt-pos-purple');
      localStorage.setItem('dt-theme-migrated-brand', '1');
    }
  } catch {}
  return (localStorage.getItem('desi-pos-theme') as ThemeId) || 'dt-pos-purple';
}
